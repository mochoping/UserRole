...
public class AirQualityService {
    ...
    //요청 주소  http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMinuDustFrcstDspth
    private final String API_AIR_URL = "http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMinuDustFrcstDspth";
    private final String SERVICE_KEY = "RlrMNFCsyGmkQQqIJ9pI5aDYSEh5TrqYUKrRtPBOysCzwa%2FrmgSlGQbRZp4%2FHpyw0k4Z2QACgWDBUzeCJqUJZw%3D%3D";// 컨피그에 널고 불러오기 필요한 키
